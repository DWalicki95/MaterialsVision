#!/usr/bin/env python3
"""
Script to filter microscope image files based on magnification values in
filenames.
...
Magnification is extracted from the pattern _XX_ where XX is the magnification
value.
